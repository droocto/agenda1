        ...
        <div class="brdPad">
          <div id="mainDiv">
            ...
            <div id="imDiv" class="showit">
              <p><img class="right" src="images/ib.gif" alt="<?php echo $l->m('im_001'); ?>" title="<?php echo $l->m('im_001'); ?>" width="48" height="48" border="0" /><strong><span class="hilight">CMS / Organizador de Im&aacute;genes</strong></p>
              <p align="justify">Este sistema le permite organizar de la forma m&aacute;s sencilla e intiutiva las im&aacute;genes de su Sitio Web.<br><br>
                Para Insertar una imagen a la p&aacute;gina web que se encuentra editando, haga clic en el bot&oacute;n "Insertar" de la izquierda.</p>
                ...
                <div id="fileDiv" class="showit">
                  ...
                  <div id="fiUplDiv" class="hideit">
                    <div class="rowDiv">
                      ...
                      <input name="nfile[]" type="file" class="fldlg" id="nfile[]" size="53" accept="image/*" style="font-size:9px;" />
                      <span>
