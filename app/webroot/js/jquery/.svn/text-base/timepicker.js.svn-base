...
Timepicker.prototype = {
    ...
    _generateHtml: function ()
    {
		...
		html += '<button class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" onclick="DP_jQuery.datepicker._hideDatepicker();" type="button">OK</button>';
		html += '</div>';
